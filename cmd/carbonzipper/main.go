...
func sendStats(stats *types.Stats) {
	...
	Metrics.Timeouts.Inc(stats.Timeouts)
	Metrics.FindErrors.Inc(stats.FindErrors)
	Metrics.RenderErrors.Inc(stats.RenderErrors)
	Metrics.InfoErrors.Inc(stats.InfoErrors)
	Metrics.SearchRequests.Inc(stats.SearchRequests)
	Metrics.SearchCacheHits.Inc(stats.SearchCacheHits)
	Metrics.SearchCacheMisses.Inc(stats.SearchCacheMisses)
	Metrics.CacheMisses.Inc(stats.CacheMisses)
	Metrics.CacheHits.Inc(stats.CacheHits)
}
